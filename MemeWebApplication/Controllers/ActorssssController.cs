...
{
    public class ActorssssController : Controller
    {
        ...
        public IActionResult SearchbyActor(string SearchString)
        {
            var result = (from c in _context.Actors
                          select c).ToList();

            if (!string.IsNullOrEmpty(SearchString))
            {
                result = (_context.Actors.Where(x => x.Name.Contains(SearchString))).ToList();
